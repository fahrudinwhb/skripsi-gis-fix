...
<head>
    ...
    <title>Ubah Data Kecelakaan</title>
                ...
                <section class="content">
                    <div class="">
                        ...
                        <section class="content-header">
                            <h1>
              Data Kecelakaan Baru
              <small>Kota Batu</small>
            </h1>
                            <ol class="breadcrumb">
                  ...
                  foreach ($data_kecelakaan as $dk) {?>
                                            <form class="form-horizontal" action="<?php echo site_url('c_kelola/data_baru/'.$dk['ID_KECELAKAAN']) ?>" method="post">
                                                <?php } ?>
                                                    <div class="box-body">
                                                        <div class="form-group">
                                                            <label for="inputEmail3" class="col-sm-2 control-label">Kode Titik</label>
                                                            <div class="col-sm-10">
                                                                <select type="option" class="form-control" id="opsi" placeholder="" name="kode_titik">
                                                                    <option>
                                                                        <?php foreach ($data_kecelakaan as $dk) {
                              echo $dk['KODE_TITIK'];
                            } ?>
                                                                    </option>
                                                                    <?php
                            foreach ($titik as $t) {
                             ?>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" value="<?php foreach ($data_kecelakaan as $dk){
                            echo $dk['ID_JALAN'];
                          } ?>" placeholder="Nama Jalan" name="id_jalan" id="id_jalan" readonly> </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" value="<?php foreach ($data_kecelakaan as $dk){
                            echo $dk['Name'];
                          } ?>" placeholder="Nama Jalan" name="nama_jalan" id="nama_jalan" readonly> </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="inputPassword3" class="col-sm-2 control-label">Kecamatan</label>
                                                            <div class="col-sm-10">
                                                                <select type="option" class="form-control" placeholder="" name="kecamatan">
                                                                    <option>
                                                                        <?php foreach ($data_kecelakaan as $dk) {
                              echo $dk['Kecamatan'];
                            } ?>
                            ...
                            foreach ($wilayah as $w) {
                             ?>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="number" class="form-control" value="<?php foreach ($data_kecelakaan as $dk){
                            echo $dk['T_MENINGGAL'];
                          } ?>" placeholder="Totak Meninggal" name="meninggal"> </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="inputPassword3" class="col-sm-2 control-label">Luka Berat</label>
                                                            <div class="col-sm-10">
                                                                <input type="number" class="form-control" value="<?php foreach ($data_kecelakaan as $dk){
                            echo $dk['T_LUKA_BERAT'];
                          } ?>" placeholder="Total Luka Berat" name="luka_berat"> </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="inputPassword3" class="col-sm-2 control-label">Luka Ringan</label>
                                                            <div class="col-sm-10">
                                                                <input type="number" class="form-control" value="<?php foreach ($data_kecelakaan as $dk){
                            echo $dk['T_LUKA_RINGAN'];
                          } ?>" placeholder="Total Luka Ringan" name="luka_ringan"> </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="number" class="form-control" value="<?php foreach ($data_kecelakaan as $dk){
                            echo $dk['TOTAL_K'];
                          } ?>" placeholder="Total Kecelakaan" name="total"> </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="inputPassword3" class="col-sm-2 control-label">Waktu</label>
                                                            <div class="col-sm-10">
                                                                <input type="date" class="form-control" value="<?php foreach ($data_kecelakaan as $dk){
                            echo $dk['WAKTU'];
                          } ?>" placeholder="" name="waktu"> </div>
                                                        </div>
                                                    </div>
                                                    <!-- /.box-body -->
                                                    <div class="box-footer">
                                                        <a href="<?php echo site_url('c_kelola/lihat_data'); ?>">
