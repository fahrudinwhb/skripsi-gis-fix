    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <section class="content">
                <section class="content-header">
                    <h1>Tambah Lokasi Kecelakaan<small>Kota Batu</small></h1> </section>
                <!--maps-->
                            ...
                            <form action="<?php echo site_url('c_kelola/tambah_koordinat') ?>" method="post">
                                ...
                                <div class="col-xs-4">
                                    <div class="input-group"> <span class="input-group-addon"><i class="fa fa-barcode"></i></span>
                                        <input type="text" class="form-control" placeholder="Kode" id="kode" name="kode_titik" onkeyup="validkode(this)" required> </div>
                                ...
                                <div class="col-xs-4" hidden="">
                                    <div class="input-group"> <span class="input-group-addon"><i class="fa fa-road"></i></span>
                                        <input type="text" id="id_jal" class="form-control" placeholder="IDJalan" name="id_jal" required> </div>
                                </div>
                                <div class="col-xs-4">
                                    <div class="input-group"> <span class="input-group-addon"><i class="fa fa-road"></i></span>
                                        <input type="text" id="nam_jal" class="form-control" placeholder="Nama Jalan" name="nam_jal" required readonly> </div>
                                </div>
      ...
      var json_wilayahkecamatan0=<?php echo $w; ?>;
        ...
        <script type="text/javascript">
            $.ajaxSetup({
                type: "POST"
                , url: "<?php echo base_url('index.php/c_otomatis/ajax_kode'); ?>"
                , cache: false
            , });
            $("#kode").keyup(function () {
                var kode_t = $("#kode").val();
                if (kode_t.length == 5) {
                    ...
                    $("#peringatan").html('Panjang ID Harus 5 Karakter');
                    $(':input[type="submit"]').prop('disabled', true);
                }
            });
        </script>
        <script language='javascript'>
            function validkode(kode) {
                if (!/^[0-9A-Za-z]+$/.test(kode.value)) {
                    window.alert('Hanya bisa input angka(0-9) , (A-Z)');
                    kode.value = kode.value.substring(0, kode.value.length - 1);
                }
            }
        </script>
        <!-- end new maps -->
