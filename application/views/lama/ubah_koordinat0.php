  ...
  <div class="content-wrapper">
    <div class="content">
      ...
      <section class="content-header">
        <h1>Ubah<small>Lokasi Kecelakaan</small></h1>
      </section>
      <!-- Main content -->
                        ...
                        <form action="<?php echo site_url('c_kelola/koordinat_baru/'.$t->KODE_TITIK) ?>" method="post">
                            ...
                            <div class="col-xs-2">
                                <div class="input-group"> <span class="input-group-addon"><i class="fa fa-barcode"></i></span>
                                    <input type="text" class="form-control" placeholder="Kode" name="kode_titik" value="<?php echo $t->KODE_TITIK ?>" required> </div>
                            </div>
                            <div class="col-xs-4">
                                <div class="input-group"> <span class="input-group-addon"><i class="fa fa-map-pin"></i></span>
                                    <input type="text" id="latclicked" class="form-control" placeholder="Latitude" name="latitude" value="<?php echo $t->LATITUDE ?>" required> </div>
                            </div>
                            <div class="col-xs-4">
                                <div class="input-group"> <span class="input-group-addon"><i class="fa fa-map-pin"></i></span>
                                    <input type="text" id="longclicked" class="form-control" placeholder="Longitude" name="longitude" value="<?php echo $t->LONGITUDE ?>" required> </div>
                            </div>
                            <div class="col-xs-2">
