...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/sweetalert2.min.css"> </head>
    ...
    <div class="wrapper">
					...
					?>
					    ...
					    <i class="fa fa-angle-left pull-right"></i>
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li class="active"><a href="<?php echo site_url('c_kelola/kelola_koordinat') ?>"><i class="fa fa-circle-o"></i> Kelola Koordinat</a></li>
        ...
        <div class="content-wrapper">
                            ...
                            <div class="col-xs-12">
                                <div class="box">
                                    <div class="box-header">
                                        ...
                                        <div class="col-xs-2">
                                            <a href="<?php echo site_url('add_peta')?>">
                                                <button type="button" class="btn btn-block btn-success btn-lg">Tambah Lokasi</button>
                                            </a>
                                        </div>
			                               ...
			                               foreach($titik as $t){
			                                ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="col-xs-6">
                                                                    <a class="glyphicon glyphicon-edit" href="<?php echo site_url ('change_peta/peta/'.$t->KODE_TITIK); ?>"></a>
                                                                </div>
                                                                <div class="col-xs-6">
                                                                    <a class="glyphicon glyphicon-trash" id="hapus" href="<?php echo ('hapus_koordinat/'.$t->KODE_TITIK); ?>" onclick="return konfirmasi('<?php echo $t->KODE_TITIK ?>')"></a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <?php
            ...
            <script type="text/javascript" language="JavaScript">
                function konfirmasi(kode_titik) {
                    var user = $(kode_titik).val();
                    tanya = confirm("Anda Yakin Akan Menghapus Data Ini : " + kode_titik + " ?");
